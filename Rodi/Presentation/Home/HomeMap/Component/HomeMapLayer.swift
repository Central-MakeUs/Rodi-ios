...
struct HomeMapLayer: View {
    ...
    var body: some View {
        ...
        KakaoMapContainerView(
            ...
            userLocation: homeStore.state.map.userLocationCoordinate,
            userHeadingDegrees: homeStore.state.map.userHeadingDegrees,
            routeOverlay: homeStore.state.bottomSheet.selectedRouteOverlay,
